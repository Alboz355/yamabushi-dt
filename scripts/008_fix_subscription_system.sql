...
-- Insert subscription plans (fixed encoding issues)
INSERT INTO subscription_plans (plan_type, name, price, duration_months, features) VALUES
('monthly', 'Abonnement Mensuel', 89.00, 1, ARRAY['Acces a tous les cours', 'Suivi de progression basique', 'Reservation de cours']),
('six_months', 'Abonnement 6 Mois', 600.00, 6, ARRAY['Acces a tous les cours', 'Suivi de progression avance', 'Reservation prioritaire', 'Analyses detaillees', 'Objectifs personnalises']),
('annual', 'Abonnement Annuel', 1000.00, 12, ARRAY['Acces a tous les cours', 'Suivi de progression premium', 'Reservation prioritaire', 'Analyses detaillees', 'Objectifs personnalises', 'Seances privees incluses', 'Rapports d evolution']);
